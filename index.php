<?php
use Roberto\Aluraplay\Domain\Infrastruc\CreateConncetion;

require_once 'vendor/autoload.php';
$conn = CreateConncetion::createConection();
...
<head>
    ...
    <link rel="stylesheet" href="/src/Asserts/css/reset.css">
    <link rel="stylesheet" href="/src/Asserts/css/estilos.css">
    <link rel="stylesheet" href="/src/Asserts/css/flexbox.css">
    <title>AluraPlay</title>
    <link rel="shortcut icon" href="/src/Asserts/img/favicon.ico" type="image/x-icon">
</head>
    ...
    <header>
        ...
        <nav class="cabecalho">
            ...
            <div class="cabecalho__icones">
                <a href="/src/Domain/pages/enviar-video.html" class="cabecalho__videos"></a>
                <a href="/src/Domain/pages/login.html" class="cabecalho__sair">Sair</a>
            </div>
        </nav>
    ...
    <ul class="videos__container" alt="videos alura">
        <li class="videos__item">
            ...
            <div class="descricao-video">
                <img src="/src/Asserts/img/logo.png" alt="logo canal alura">
                <h3>Qual é o melhor hardware para programação com Mario Souto</h3>
                <div class="acoes-video">
                    <a href="/src/Domain/pages/enviar-video.html">Editar</a>
                    <a href="/src/Domain/pages/enviar-video.html">Excluir</a>
                </div>
            </div>
        </li>
        <li class="videos__item">
